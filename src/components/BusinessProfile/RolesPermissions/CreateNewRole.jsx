...
import { BusinessRoleSchema } from "@/utils/yup-schemas";
import { addNewBusinnessRole } from "@/services/business-profile/roles-permissions";
...
const CreateNewRole = ({ onClose }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: BusinessRoleSchema,
    onSubmit: async (values, { resetForm, setSubmitting }) => {
      submitHandler({
        successMsg: "Your new role has been added successfully!",
        onSubmit: async () => {
          await addNewBusinnessRole(values);
    ...
    <div>
      <form onSubmit={formik.handleSubmit}>
        <Box>
          ...
          <Typography
            variant="subtitle1"
            className="!font-inter !mb-2 !text-lg"
          >
            Role Name
          </Typography>
          ...
          <div className="flex items-center mt-8 justify-between">
            ...
            <Switch
              ...
              value={getSelectedPermissions("loyalty_management", 4)}
              onChange={(event) =>
        ...
        <Box className="space-y-6 mt-6">
          ...
          <Box>
            ...
            <div className="flex justify-center flex-wrap gap-6">
              ...
              <Button
                className={`!bg-[#ffe2d3] ${
                  !formik.isSubmitting && "!text-[#ff6f00]"
                } !py-2 !px-10 !mt-10 !textlg`}
                type="submit"
