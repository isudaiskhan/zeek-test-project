      ...
      <CustomDialogContent>
        <Box className="flex flex-col gap-8 p-4">
          ...
          <div className="flex flex-col justify-start items-start gap-2 ">
            ...
            <Typography sx={paragraphSX}>
              Choose a time frame in the day where the offer will be available.
            </Typography>
          ...
          <div className="flex flex-col justify-start items-start gap-2">
            ...
            <Typography sx={paragraphSX}>
              ...
              will be available. If the offer will be available every day of the
              week, select “all” below.
            </Typography>
            <Autocomplete
              disablePortal
              options={days}
          ...
          <div className="flex flex-col justify-start items-start gap-2 ">
            ...
            <Typography sx={paragraphSX}>
              Choose if you would like to apply double points for redeeming this
              offer.
            </Typography>
            <Box className="flex flex-col items-center justify-center gap-1 py-5 w-auto">
              <div
